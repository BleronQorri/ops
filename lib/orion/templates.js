...
tier: {{tier}}
lang: {{lang}}
# secrets: [SOME_TOKEN]         # env vars ops should ask for once and pass in
examples:
  - args: "--help"
...
- Secrets: none / \`SOME_TOKEN\` from the environment (prompted when unset; list it
  in the frontmatter \`secrets:\` and \`ops run\` asks once and passes it in).
