...
const TIERS = {
  ...
  sandbox: { label: "Sandbox / external", blurb: "Invopop sandbox or Comarch UAT; refuses production credentials", color: "sql" },
  "staging-destructive": { label: "Staging destructive wipe (gated)", blurb: "deletes staging rows; refuses production namespaces", color: "warn" },
};
