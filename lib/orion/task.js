...
function addRun(parent) {
  ...
  gh(run, {
    ...
    examples: [
      ...
      { cmd: "ops task run resend_stuck_invoices --help", note: "the script's own help, not this page" },
