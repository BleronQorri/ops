...
function register(program) {
  ...
  gh(orion, {
    examples: [{ cmd: "ops orion script list" }, { cmd: "ops orion script view force_retry_invoices" }, { cmd: "ops orion docs check" }],
  });
  ...
  const script = orion
    ...
    .enablePositionalOptions();
  gh(script, {
    examples: [{ cmd: "ops orion script list --env production" }, { cmd: "ops orion script view force_retry_invoices" }],
  });
